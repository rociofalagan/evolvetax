    ...
    <div className="min-h-screen bg-[#eeede9]">
      ...
      <section className="px-6 pb-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 bg-white rounded-3xl p-10 shadow-sm border border-[#1b1b1b]/10">
          <div className="text-center">
            <div className="text-5xl font-bold text-[#78586F] mb-2">600+</div>
            <div className="text-[#1b1b1b]/70">Companies Established</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-[#78586F] mb-2">$300M+</div>
            <div className="text-[#1b1b1b]/70">Total Tax Savings</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-[#78586F] mb-2">98%</div>
            <div className="text-[#1b1b1b]/70">Client Satisfaction</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-[#78586F] mb-2">10+</div>
          ...
          <div className="grid md:grid-cols-4 gap-6">
            {industries.map((industry, idx) => (
              <div key={idx} className="bg-[#eeede9] rounded-2xl p-6 text-center border border-[#1b1b1b]/5">
                ...
                <p className="text-[#78586F] font-semibold">{industry.count} clients</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div key={idx} className="bg-white rounded-3xl p-8 shadow-sm border border-[#1b1b1b]/10">
              ...
              <div className="border-t border-[#1b1b1b]/10 pt-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm font-semibold text-[#78586F]">Saved {testimonial.savings}</span>
                </div>
              </div>
            </div>
          ))}
      ...
      <section className="px-6 py-24 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/contact"
            className="inline-block px-12 py-5 bg-[#78586F] text-[#eeede9] rounded-full font-bold text-lg hover:bg-[#78586F]/90 transition-all shadow-lg"
          >
            Get Started Today
          </Link>
        </div>
