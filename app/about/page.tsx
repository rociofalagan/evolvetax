  ...
  return (
    <div className="min-h-screen bg-[#eeede9]">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="bg-[#eeede9] rounded-3xl p-10 border border-[#1b1b1b]/10">
              <div className="w-16 h-16 bg-[#6B2C2C] rounded-2xl flex items-center justify-center mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              <div key={idx} className="flex items-start gap-4">
                <div className="w-6 h-6 bg-[#6B2C2C] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto text-center">
        ...
        <Link
          href="/contact"
          className="inline-block px-12 py-5 bg-[#6B2C2C] text-[#eeede9] rounded-full font-bold text-lg hover:bg-[#6B2C2C]/90 transition-all"
        >
