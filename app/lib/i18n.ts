...
const en = {
  ...
  services: {
    ...
    oneOff: { lead: 'Just need a one-off consultation or a second opinion?', link: 'We do that too.' },
  ...
  process: {
    ...
    steps: [
      { title: 'First conversation', text: 'You tell us about your situation and goals. We tell you honestly whether we can help.' },
      { title: 'Diagnosis & proposal', text: 'We analyse your case and send you a proposal with a clear scope and fees.' },
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'It depends on the scope. After the first conversation we send you a proposal with clear fees, before any work starts.',
      },
      {
  ...
  contact: {
    ...
    text: 'Tell us about your situation. We review every request personally and, if it’s a fit, we’ll suggest a first conversation.',
    bullets: [
...
const es: Dictionary = {
  ...
  services: {
    ...
    learnMore: 'Saber más',
    oneOff: { lead: '¿Solo necesitas una consulta puntual o una segunda opinión?', link: 'También la hacemos.' },
  ...
  process: {
    ...
    steps: [
      { title: 'Primera conversación', text: 'Nos cuentas tu situación y lo que quieres conseguir. Te decimos con honestidad si podemos ayudarte.' },
      { title: 'Diagnóstico y propuesta', text: 'Analizamos tu caso y te enviamos una propuesta con el alcance y los honorarios claros.' },
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: '¿Cuánto cuesta?',
        a: 'Depende del alcance. Después de la primera conversación te enviamos una propuesta con honorarios claros, antes de empezar nada.',
      },
      {
  ...
  contact: {
    ...
    text: 'Cuéntanos tu situación. Revisamos cada solicitud personalmente y, si encaja con lo que hacemos, te proponemos una primera conversación.',
    bullets: [
