      ...
      <section className="px-6 pb-16 max-w-7xl mx-auto">
        <div className="bg-white rounded-3xl p-10 md:p-12 shadow-sm border border-[#1b1b1b]/10">
          <div className="flex items-center gap-4 mb-6">
            <span className="px-4 py-1 bg-[#6B2C2C] text-[#1b1b1b] rounded-full text-sm font-semibold">Featured</span>
          ...
          <div className="flex items-center gap-6">
            <button className="px-8 py-4 bg-[#6B2C2C] text-[#eeede9] rounded-full font-semibold hover:bg-[#6B2C2C]/90 transition-all">
              Read Full Guide
            </button>
          ...
          {articles.map((article, idx) => (
            <div key={idx} className="bg-white rounded-3xl p-8 shadow-sm border border-[#1b1b1b]/10 hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-between mb-4">
                <span className="text-[#6B2C2C] font-semibold text-sm">{article.category}</span>
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="text-[#6B2C2C] font-semibold hover:underline">Read →</button>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <form className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
            <input
              ...
              className="flex-1 px-6 py-4 rounded-full bg-[#eeede9] text-[#1b1b1b] focus:outline-none focus:ring-2 focus:ring-[#6B2C2C]"
            />
            <button className="px-8 py-4 bg-[#6B2C2C] text-[#eeede9] rounded-full font-bold hover:bg-[#6B2C2C]/90 transition-all">
              Subscribe
            </button>
          </form>
        </div>
